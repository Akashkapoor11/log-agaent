...
-- LOG SOURCES
INSERT INTO log_sources (source_name, source_type, region)
SELECT 'Azure', 'Cloud', 'India' WHERE NOT EXISTS (SELECT 1 FROM log_sources WHERE source_name = 'Azure');

-- =====================================================
-- RAW LOGS  (18 rows, explicit UUIDs for idempotency)
-- =====================================================
INSERT INTO raw_logs (log_id, source_id, raw_event, hash_signature, is_duplicate)
SELECT 'a1000001-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_001', false FROM log_sources s WHERE s.source_name='Azure'
...
SELECT 'a1000002-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_002', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000003-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_003', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;

INSERT INTO raw_logs (log_id, source_id, raw_event, hash_signature, is_duplicate)
SELECT 'a1000004-0000-0000-0000-000000000000'::uuid, s.source_id,
  '{"user":"priya.sharma","ip":"116.31.116.50","country":"China","device":"Mac","login_result":"failed"}'::jsonb,
  'hash_rl_004', true FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000005-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_005', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000006-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_006', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000007-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_007', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000008-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_008', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000009-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_009', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000010-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_010', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000011-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_011', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000012-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_012', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000013-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_013', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000014-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_014', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000015-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_015', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000016-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_016', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000017-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_017', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;
...
SELECT 'a1000018-0000-0000-0000-000000000000'::uuid, s.source_id,
  ...
  'hash_rl_018', false FROM log_sources s WHERE s.source_name='Azure'
ON CONFLICT (log_id) DO NOTHING;

-- =====================================================
-- NORMALIZED EVENTS  (18 rows linked to raw logs)
-- =====================================================
INSERT INTO normalized_events (event_id, log_id, user_email, ip_address, geo_location, device, event_type, login_status, risk_score, anomaly_flag, normalized_json, event_timestamp)
...
-- ANOMALY ALERTS
-- =====================================================
INSERT INTO anomaly_alerts (alert_id, event_id, severity, risk_percent, anomaly_reason, alert_status)
...
-- AUDIT LOGS
-- =====================================================
INSERT INTO audit_logs (audit_id, action_type, actor, metadata, action_timestamp)
VALUES
